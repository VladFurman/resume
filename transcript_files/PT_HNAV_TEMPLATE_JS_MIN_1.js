...
var ptIframe = {
 ...
 var keyCode = ptUtil.getKeyCode(evt); var actualKeyCode = keyCode | 0x40; var isCtrlKey = ptUtil.isCtrlKey(evt);  var isAltKey = ptUtil.isAltKey(evt); if (isCtrlKey && (actualKeyCode == 89 || actualKeyCode == 90)) {
