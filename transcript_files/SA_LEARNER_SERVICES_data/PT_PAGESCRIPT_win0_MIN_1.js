...
function getPgltTopY(obj) 
{
 ...
 var pgltHeader = ptUtil.getElemsByClass("PTPAGELETHEADER", p, "table"); if (p.tagName.toLowerCase() === "li" && objGP.style.height != "") {
...
if (target && target.form)
 ...
 submitAction_win0(document.win0, "#KEY" + code);}else{
...
var frm = document.win0;if (!frm) return;var frmlen = frm.length;objBeforeOrAfterFocusSave = null; var objBefore = null; var bAfter = 0; var b = navigator.userAgent.toLowerCase();var bIE = (b.indexOf("msie") != -1) ? 1:0;var bIE8 = (bIE && b.indexOf("trident/4.0;") != -1) ? 1:0; for (i = 0; i < frmlen; ++i)
{
...
function tryFocus0New(obj)
{
 ...
 {
 var b = navigator.userAgent.toLowerCase(); var bIE = (b.indexOf("msie") != -1) ? 1:0; var bIE8 = (bIE && b.indexOf("trident/4.0;") != -1) ? 1:0;   var tgName = null; if (typeof obj.tagName != "undefined")
...
if (loader != null && loader.GetInProcess2()) return;if (loader != null && loader.GetInProcess())
 {
...
if (ptGridObj_win0)
 ptGridObj_win0.saveScrollPos();form.ICResubmit.value=nResubmit;form.ICAction.value=name;form.ICXPos.value = ptCommonObj2.getScrollX();form.ICYPos.value = ptCommonObj2.getScrollY();bcUpdater.getAdvSrchLblFrmCriteria(name, form);if (typeof bAjax != "undefined" && !bAjax && (typeof params == "undefined" || params == null || params == "") && (typeof popupObj_win0.isModalWidget == "undefined" || !popupObj_win0.isModalWidget))
...
function doUpdateParent(form, name) {
 ...
 form.target = winParent.name; form.ICAction.value = name; if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField(); winParent.loader = null; winParent.aAction_win0(form, name); }
}
...
function resizeZoomGrid(id, w, h) {
 ...
 nMaxHeight = nMaxBodyHeight; var oS = null; var nGridNewHeight = 0;    var oS1 = document.getElementById(gSID);  oS1.id = gSID+"zzzz";  oS = document.getElementById(gSID);  if (!oS)
...
bcUpdater.setStoredData(bcUpdater.isRCService, "T");processing_win0(1, 3000);if (nOpenMode == "0")
