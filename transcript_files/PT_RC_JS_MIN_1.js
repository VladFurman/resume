...
ptSidePanel.prototype = {
 ...
 ptrc.openMaxServices(); if (!RCPage.visible)
...
else if(key == 38) 
{
 ...
 openMaxServices:function () {
 if (this.typeRC == "") return;  if (ptrc.rcMenu == null)
 ptrc.onUpdateRCMenu();  if (ptrc.rcMenu == null)
 return;  this.bFirstSideFrameExpanded = true;  var nNumMinPglt = 0; var rc = window.frames[this.typeRC + 'RelatedContent']; for (var i=0; i<this.rcMenu.services.length; i++) {
 if (this.rcMenu.services[i].isDefault == "Y") 
 eval(this.rcMenu.getValue(this.rcMenu.services[i].id)); else {
 ...
 var spl = value.split("\""); return spl[1]; },
